...
//                LinearLayout.LayoutParams lp= (LinearLayout.LayoutParams) mWapper.getLayoutParams();
                tv.setLayoutParams(new LinearLayout.LayoutParams((this.getScreenWidth()-80)/3, ViewGroup.LayoutParams.WRAP_CONTENT));
                mWapper.addView(tv);
